wget https://huggingface.co/datasets/KBlueLeaf/danbooru2023-sqlite/resolve/main/danbooru2023.db -P . -q --show-progress
wget https://huggingface.co/junjuice0/test/resolve/main/embeds_bf16.pt -P . -q --show-progress
